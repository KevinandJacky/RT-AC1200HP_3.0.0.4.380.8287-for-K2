...
void rt_gsw_init(void)
{
	...
	u32	regValue;
#endif
#if defined(ASUS_RTN14U) || defined(ASUS_RTAC52U) || defined(ASUS_RTAC51U) || defined(ASUS_RTN11P) || defined(ASUS_RTN300) || defined(ASUS_RTN54U) || defined(ASUS_RTAC1200HP) || defined(ASUS_RTN56UB1) || defined(ASUS_RTN56UB2) || defined(ASUS_RTAC54U)
	volatile u32 rr;
	// reset phy
