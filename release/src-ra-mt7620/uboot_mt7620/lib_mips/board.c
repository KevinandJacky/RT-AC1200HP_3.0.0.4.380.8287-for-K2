...
/* Adjust CPU Freq from 60Mhz to 600Mhz(or CPLL freq stored from EE) */
	...
	gpio_init();
#if !defined(ASUS_RTN14U) && !defined(ASUS_RTAC52U) && !defined(ASUS_RTAC51U) && !defined(ASUS_RTN11P) && !defined(ASUS_RTN300) && !defined(ASUS_RTN54U) && !defined(ASUS_RTAC1200HP) && !defined(ASUS_RTN56UB1) && !defined(ASUS_RTAC54U) && !defined(ASUS_RTN56UB2)
	LEDOFF();
#endif
#endif	
